...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert sports analyst AI with deep knowledge of football, basketball, and cricket. 
...
Use a professional but conversational tone. Format your responses clearly with bullet points when appropriate.`;
    ...
    console.error('Error in sports-analyst function:', error);
    return new Response(
